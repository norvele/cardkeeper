...
import styles from '@/components/business/AllDeckSettings/allDeckSettings.module.scss';
...
interface IAllDeckSettingsProps {
  deckId: string;
  shadowIsVisible: boolean;
}

const AllDeckSettings: FC<IAllDeckSettingsProps> = ({
  deckId,
  shadowIsVisible,
}) => {
...
export default AllDeckSettings;
